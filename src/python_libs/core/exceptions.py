"""Centralized exception hierarchy for Python Libs.
...
class ProjectBaseError(Exception):
    """Base exception for all Python Libs errors.
    ...
    Args:
        ...
        details (dict[str, Any] | None): Additional context as key-value
            pairs.
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        Returns:
            dict[str, Any]: Dictionary with error details suitable for JSON
                serialization.
        """
        result: dict[str, Any] = {
...
class ResourceNotFoundError(ProjectBaseError):
    ...
    Args:
        ...
        resource_type (str | None): Type of resource (e.g., "User",
            "Document").
...
class AuthenticationError(ProjectBaseError):
    ...
    Args:
        ...
        details (dict[str, Any] | None): Additional context (avoid including
            sensitive data).
        error_code (str | None): Machine-readable error code.
...
class APIError(ExternalServiceError):
    ...
    Args:
        ...
        retry_after (int | None): Seconds to wait before retrying (for rate
            limits).
        details (dict[str, Any] | None): Additional context.
        error_code (str | None): Machine-readable error code.
