...
def setup_logging(
    ...
    Args:
        ...
        include_timestamp (bool): Whether to include timestamps in log output.
            Defaults to True.
        include_correlation (bool): Whether to include correlation IDs from
            request context in log output. Defaults to True. Requires API
            framework.
    ...
    def noop_processor(
        ...
        Args:
            ...
            event_dict (EventDict): The event dictionary to pass through.
...
def log_performance(
    ...
    **context: object,
    ...
    Args:
        ...
        **context (object): Additional context key-value pairs to include in
            the log.
...
if __name__ == "__main__":
    ...
    def _raise_example_error() -> None:
        ...
        Raises:
            ValueError: Always raised for demonstration purposes.
        """
